<template>
  <!-- 电催案件管理-归C案件池-页面 -->
  <section class="page tel-returnc-case-manage">
...
export default class TelReturnCCaseManage extends Vue {
  ...
  private refreshData() {
    this.telCaseManageService
      .returnCCasePool(this.model, this.pageService, this.sortService)
