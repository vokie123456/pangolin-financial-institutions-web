...
const OutsourceSettle = () => import('~/pages/system-manage/outsource-settle.vue')
const OutsourceCommission = () => import('~/pages/system-manage/outsource-commission.vue')
...
export default [
  ...
  {
    // 委外结算策略
    path: '/system-manage/outsource-settle',
    name: 'outsource-settle',
    component: OutsourceSettle
  }, 
  {
    // 委外佣金策略
    path: '/system-manage/outsource-commission',
    name: 'outsource-commission',
    component: OutsourceCommission
  }, 
