...
const InrushCaseInRecovery = () => import('~/pages/inrushcase-manage/inrush-case-in-recovery.vue')
...
export default [
  {
    ...
    path: '/inrushcase-manage/inrush-case-in-recovery',
    name: 'inrush-case-in-recovery',
    title: '回收案件',
    component: InrushCaseInRecovery
  }
]
