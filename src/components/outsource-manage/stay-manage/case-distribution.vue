<template>
  ...
  <div class="page">
    ...
    <data-box :data="caseDistributionDataListCopy.resDistModel" :page="pageService" :showPage="false">
    ...
    <div class="time-select">
      <el-form :rules="companyRules" :model="caseDistributionDataListCopy" ref="form">
        <el-row>
          <el-col :span="11">
            <el-form-item label="委外到期时间" prop="outEndDate">
              <el-date-picker
                v-model="caseDistributionDataListCopy.outEndDate" value-format="yyyy-MM-dd"
                type="date"
                placeholder="请选择日期">
              </el-date-picker>
            </el-form-item>
...
export default class AddUser extends Vue {
  ...
  private companyRules: any = {
    outEndDate: [
      { required: true, message: '请选择委外到期时间', trigger: 'blur' },
    ],
  };
